...
from videogpt_plus.model.wham_dataloader import transforms
from videogpt_plus.model.wham_dataloader.kp_utils import root_centering
from videogpt_plus.model.wham_dataloader.imutils import compute_cam_intrinsics
from videogpt_plus.model.internvideo_1.modules import clip_evl
from videogpt_plus.model.internvideo_1.modules.module_clip import CLIP
import os,sys
...
def _get_fixed_text_fea(text,clip,tokenizer):
    ...
    return clip.encode_text(input_ids).float() 
