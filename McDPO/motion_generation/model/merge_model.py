...
def main():
    ...
    parser.add_argument('--base_model', default='results/epoch1_top1_merge_20epoch', required=True, type=str,
                        help="Base model name or path")
    parser.add_argument('--tokenizer_path', default='results/epoch1_top1_merge_20epoch', type=str,
