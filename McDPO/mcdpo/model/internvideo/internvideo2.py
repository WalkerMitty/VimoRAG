...
from mcdpo.model.internvideo.pos_embed import get_3d_sincos_pos_embed, interpolate_pos_embed_internvideo2
from mcdpo.model.internvideo.flash_attention_class import FlashAttention
...
class PretrainInternVideo2(nn.Module):
    ...
    def forward(self, x, mask=None, use_image=False, x_vis_return_idx=-1, x_vis_only=False):
        ...
        # print(f"x.shape: {x.shape} x.dtype: {x.dtype}, mcdpo.dtype: {self.dtype}")
