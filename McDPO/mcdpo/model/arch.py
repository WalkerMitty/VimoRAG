    ...
    def prepare_inputs_labels_for_multimodal(self, input_ids, attention_mask, past_key_values, labels, images,
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            if len(image_token_indices) > 1:  # This is a video
                ...
                for i in temp:
                    '''
                    i : [tensor(0, device='cuda:0'), tensor(1, device='cuda:0'), tensor(2, device='cuda:0'), tensor(3, device='cuda:0'), tensor(4, device='cuda:0'), tensor(5, device='cuda:0'), tensor(6, device='cuda:0'), tensor(7, device='cuda:0'), tensor(8, device='cuda:0'), tensor(9, device='cuda:0'), tensor(10, device='cuda:0'), tensor(11, device='cuda:0'), tensor(12, device='cuda:0'), tensor(13, device='cuda:0'), tensor(14, device='cuda:0'), tensor(15, device='cuda:0')]
                    '''
